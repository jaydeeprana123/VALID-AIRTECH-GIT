...
import 'package:valid_airtech/Screens/Circular/View/employee_circular_list_by_date_screen.dart';
...
import 'employee_circular_list_screen.dart';


class EmployeeCircularScreen extends StatefulWidget {
  @override
  _EmployeeCircularScreenState createState() => _EmployeeCircularScreenState();
}

class _EmployeeCircularScreenState extends State<EmployeeCircularScreen> {
  DateTime _focusedDay = DateTime.now();
  DateTime? _selectedDay;

  CircularController circularController =
      Get.put(CircularController());
  ...
  void initState() {
    ...
    circularController.getLoginData();
  }
            ...
            child: Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  onPressed: () {
                    Get.to(EmployeeCircularListScreen());
                  },
                  child: Text(
                    'View All >',
                    style: AppTextStyle.largeBold
              ...
              child: TableCalendar(
                ...
                onDaySelected: (selectedDay, focusedDay) {
                  setState(() {
                    ...
                    Get.to(EmployeeCircularListByDateScreen(
                      date: formattedDate,
                    ));
                  });
                },
