...
import 'package:valid_airtech/Screens/Attendance/View/admin_attendance_create_screen.dart';
...
import 'package:valid_airtech/Screens/Conveyance/View/admin_conveyance_list_by_date_screen.dart';
import 'package:valid_airtech/Screens/Conveyance/View/admin_conveyance_list_screen.dart';
import '../../../Styles/app_text_style.dart';
import '../../../Styles/my_colors.dart';
import '../../../Widget/common_widget.dart';
import '../Controller/conveyance_controller.dart';
import 'admin_add_conveyance_screen.dart';
import 'admin_conveyance_payment_list_screen.dart';



class AdminConveyanceScreen extends StatefulWidget {
  @override
  _AdminConveyanceScreenState createState() => _AdminConveyanceScreenState();
}

class _AdminConveyanceScreenState extends State<AdminConveyanceScreen> {
  ...
  void initState() {
    ...
    conveyanceController.getLoginData();
  }
            ...
            child: Row(
              ...
              children: [
                ElevatedButton(
                  ...
                  onPressed: () {
                    Get.to(AdminConveyanceListScreen(empId: ""));
                  },
                  child: Text(
                    'View All >',
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    Get.to(AdminAddConveyanceScreen());
              ...
              child: TableCalendar(
                ...
                onDaySelected: (selectedDay, focusedDay) {
                  setState(() {
                    ...
                    Get.to(AdminConveyanceListByDateScreen(
                      empId: "",
                      date: formattedDate,
                    ));
                  });
