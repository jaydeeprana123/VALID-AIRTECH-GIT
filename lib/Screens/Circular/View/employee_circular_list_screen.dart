...
class EmployeeCircularListScreen extends StatefulWidget {
  @override
  _EmployeeCircularListScreenState createState() => _EmployeeCircularListScreenState();
}

class _EmployeeCircularListScreenState extends State<EmployeeCircularListScreen> {
