...
class AddCircuarScreen extends StatefulWidget {
  @override
  _AddCircuarScreenState createState() => _AddCircuarScreenState();
}

class _AddCircuarScreenState extends State<AddCircuarScreen> {
                    ...
                    Padding(
                      ...
                      child: CommonButton(
                        ...
                        onCustomButtonPressed: () async {
                          ...
                          if (circularController.filePath.value.isEmpty) {
                          ...
                          circularController.callCreateCircular(DateFormat(
