...
class PlanningListByDateScreen extends StatefulWidget {

  final String date;
  PlanningListByDateScreen({
    Key? key,
    required this.date,
  }) : super(key: key);

  @override
  _PlanningListByDateScreenState createState() => _PlanningListByDateScreenState();
}

class _PlanningListByDateScreenState extends State<PlanningListByDateScreen> {
