...
class HomeAllowanceFilterDialog extends StatefulWidget {
  @override
  _HomeAllowanceFilterDialogState createState() => _HomeAllowanceFilterDialogState();
}

class _HomeAllowanceFilterDialogState extends State<HomeAllowanceFilterDialog> {
  final HomeAllowanceController controller = Get.find<HomeAllowanceController>();
