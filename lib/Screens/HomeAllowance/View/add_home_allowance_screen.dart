...
class AddHomeAllowanceScreen extends StatefulWidget {
  @override
  _AddHomeAllowanceScreenState createState() => _AddHomeAllowanceScreenState();
}

class _AddHomeAllowanceScreenState extends State<AddHomeAllowanceScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      homeAllowanceController.controllerAmount.value.text = "0";
                ...
                Padding(
                  ...
                  child: CommonButton(
                    ...
                    onCustomButtonPressed: () async {
                      ...
                      homeAllowanceController.callCreateHomeAllowance();
