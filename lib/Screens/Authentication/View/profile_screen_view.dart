      ...
      home: Scaffold(
        ...
        body:Obx(() => Column(
          children: [
            ...
            profileText(loginController.loginData.value.eEmployeeName??"", "Name"),
            profileText(loginController.loginData.value.eUserName??"", "User Name"),
            profileText(loginController.loginData.value.eEmail??"", "Email"),
            profileText(loginController.loginData.value.eMobile??"", "Mobile Number"),
            const SizedBox(height: 20),
            Row(
