                ...
                Padding(
                  ...
                  child: CommonButton(
                    ...
                    onCustomButtonPressed: () async {
                      ...
                      serviceController.createInstrumentRequest.value = CreateInstrumentRequest();
                      serviceController.createInstrumentRequest.value.headInstrumentId = selectedInstrumentName??"";
                      serviceController.createInstrumentRequest.value.instrumentIdNo = serviceController.instrumentIdNoController.value.text;
                      serviceController.createInstrumentRequest.value.srNo = serviceController.srNoController.value.text;
                      serviceController.createInstrumentRequest.value.modelNo = serviceController.modelNoController.value.text;
                      serviceController.createInstrumentRequest.value.make = serviceController.makeController.value.text;

                      serviceController.callCreateInstrument();
