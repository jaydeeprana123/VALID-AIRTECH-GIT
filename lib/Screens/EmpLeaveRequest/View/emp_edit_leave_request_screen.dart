...
class EmpEditLeaveRequestScreen extends StatefulWidget {
  @override
  _EmpEditLeaveRequestScreenState createState() => _EmpEditLeaveRequestScreenState();
}

class _EmpEditLeaveRequestScreenState extends State<EmpEditLeaveRequestScreen> {
  ...
  void initState() {
    super.initState();
    empLeaveRequestController.isEdit.value = false;

    selectedOption = empLeaveRequestController.selectedEmpLeaveRequest.value.leaveRequestType.toString();

    if((empLeaveRequestController.selectedEmpLeaveRequest.value.fromDate??"").isNotEmpty){
      DateFormat format = DateFormat("dd-MM-yyyy");
      fromDate = format.parse(empLeaveRequestController.selectedEmpLeaveRequest.value.fromDate??"");
    ...
    if((empLeaveRequestController.selectedEmpLeaveRequest.value.toDate??"").isNotEmpty){
      DateFormat format = DateFormat("dd-MM-yyyy");
      toDate = format.parse(empLeaveRequestController.selectedEmpLeaveRequest.value.toDate??"");
      setState(() {
    ...
    empLeaveRequestController.controllerNumOfLeaves.value.text = empLeaveRequestController.selectedEmpLeaveRequest.value.numberOfLeaveDays??"";
    empLeaveRequestController.controllerReason.value.text = empLeaveRequestController.selectedEmpLeaveRequest.value.reason??"";
    empLeaveRequestController.controllerNameOfEmp.value.text = empLeaveRequestController.loginData.value.name??"";
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              empLeaveRequestController.isEdit.value = true;
            },
          ),
          ...
          IconButton(
            ...
            onPressed: () {
              Get.defaultDialog(
                  ...
                  onConfirm: () async {
                    Navigator.pop(context);
                    empLeaveRequestController.callDeleteLeaveRequest(empLeaveRequestController.selectedEmpLeaveRequest.value.id.toString());
                ...
                child: Column(
                  ...
                  children: [
                   ...
                   selectedOption == "2"?  Column(
                    ...
                    // Login Button
                    empLeaveRequestController.isEdit.value? Padding(
                      ...
                      child: CommonButton(
                        ...
                        onCustomButtonPressed: () async {
                          ...
                          empLeaveRequestController.addLeaveRequest.value.id = empLeaveRequestController.selectedEmpLeaveRequest.value.id.toString();
