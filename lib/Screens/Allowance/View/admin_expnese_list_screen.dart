...
class AdminExpenseListScreen extends StatefulWidget {
  ...
  @override
  _AdminExpenseListScreenState createState() => _AdminExpenseListScreenState();
}

class _AdminExpenseListScreenState extends State<AdminExpenseListScreen> {
